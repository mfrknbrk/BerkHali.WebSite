...
const BlogDetailsKaroHaliTemizligi = () => {
    ...
    return (
        <Fade triggerOnce direction='up' duration={1000} delay={400} className="bb-blog-details-contact">
            ...
            <div className="inner-blog-details-contact">
                <span>Jan 10,2022 - BH</span>
                <h4 className="sub-title">Karo Halı Temizliği ve Bakımı Nasıl Yapılır?</h4>
...
export default BlogDetailsKaroHaliTemizligi
