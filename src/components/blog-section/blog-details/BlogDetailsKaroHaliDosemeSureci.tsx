...
const BlogDetailsKaroHaliDosemeSureci = () => {
    ...
    return (
        <Fade triggerOnce direction='up' duration={1000} delay={400} className="bb-blog-details-contact">
            ...
            <div className="inner-blog-details-contact">
                <span>Feb 12,2022 - BH</span>
                <h4 className="sub-title">Karo Halı Döşeme Süreci: Adım Adım Uygulama Rehberi</h4>
...
export default BlogDetailsKaroHaliDosemeSureci
