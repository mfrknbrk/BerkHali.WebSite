...
import BlogDetailsKaroHaliDosemeSureci from './blog-details/BlogDetailsKaroHaliDosemeSureci'
...
const BlogDetailKaroHaliDosemeSureci = () => {
  ...
  return (
    <>
      ...
      <Col xl={8} className="col-lg-7 col-12 mb-24">
        <BlogDetailsKaroHaliDosemeSureci />
      </Col>
    </>
  )
}

export default BlogDetailKaroHaliDosemeSureci
