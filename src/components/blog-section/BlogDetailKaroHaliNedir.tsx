...
import BlogDetailsKaroHaliNedir from './blog-details/BlogDetailsKaroHaliNedir'
  ...
  return (
    <>
      ...
      <Col xl={8} className="col-lg-7 col-12 mb-24">
        <BlogDetailsKaroHaliNedir />
      </Col>
    </>
  )
}

export default BlogDetailKaroHaliNedir
