...
const BlogDetailsEnDayanikliKaroHali = () => {
    ...
    return (
        <Fade triggerOnce direction='up' duration={1000} delay={400} className="bb-blog-details-contact">
            ...
            <div className="inner-blog-details-contact">
                <span>May 10,2023 - BH</span>
                <h4 className="sub-title">En Dayanıklı Karo Halı Türleri ve Özellikleri?</h4>
...
export default BlogDetailsEnDayanikliKaroHali
