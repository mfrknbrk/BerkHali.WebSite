...
import BlogDetailsKaroHaliTemizligi from './blog-details/BlogDetailsKaroHaliTemizligi'
...
const BlogDetailKaroHaliTemizligi = () => {
  ...
  return (
    <>
      ...
      <Col xl={8} className="col-lg-7 col-12 mb-24">
        <BlogDetailsKaroHaliTemizligi />
      </Col>
    </>
  )
}

export default BlogDetailKaroHaliTemizligi
