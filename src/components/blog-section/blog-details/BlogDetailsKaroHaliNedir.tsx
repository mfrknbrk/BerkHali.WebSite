...
const BlogDetailsKaroHaliNedir = () => {
    ...
    return (
        <Fade triggerOnce direction='up' duration={1000} delay={400} className="bb-blog-details-contact">
            ...
            <div className="inner-blog-details-contact">
                <span>June 30,2024 - BH</span>
                <h4 className="sub-title">Karo Halı Nedir? Avantajları ve Kullanım Alanları?</h4>
...
export default BlogDetailsKaroHaliNedir
